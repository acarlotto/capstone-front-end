...
// require('./example')
var appEvents = __webpack_require__(10);
...
var appApi = __webpack_require__(11);
...
// post
var onCreateNewListing = function onCreateNewListing() {
  // console.log(data)
  var data = getFormFields(this);
  event.preventDefault();
  appApi.newListing(data).then(appUi.newSuccess).then(function () {
    $("#showListings").click();
  }).catch(appUi.newFail);
};
...
var onGetListings = function onGetListings(event) {
  event.preventDefault();
  appApi.showListings().then(appUi.onSuccessGetListing).catch(appUi.onFailureGetListing);
};

var onGetUsersListings = function onGetUsersListings(data) {
  // console.log('events.js get all')
  // event.preventDefault()
  appApi.findAllListings().then(appUi.onSuccessGetAllListings).catch(appUi.onFailureGetAllListings);
};
...
var onDeleteListing = function onDeleteListing(event) {
  ...
  event.preventDefault();
  appApi.deleteListing(delete_id).then(appUi.deleteSuccess).then(function () {
    $("#showListings").click();
  }).catch(appUi.deleteFail);
};

var updateListing = function updateListing(event) {
  // $('#updateEvent').val(my_id)
  var data = getFormFields(this);
  var update_id = data.event.event_id;
  // console.log(data)
  event.preventDefault();
  appApi.updateListing(data, update_id).then(appUi.onUpdateSuccess).then(function () {
    $("#showListings").click();
...
module.exports = {
  ...
  onGetUsersListings: onGetUsersListings,
...
var newListing = function newListing(data) {
  return $.ajax({
...
// show user listings
var showListings = function showListings() {
...
// get all listings
var findAllListings = function findAllListings() {
...
var deleteListing = function deleteListing(deleteId) {
  return $.ajax({
...
// add patch
var updateListing = function updateListing(data, update_id) {
...
;var onSuccessGetListing = function onSuccessGetListing(data) {
  $('#message').empty();
  var listings = data.listings;
  var my_id = data.listings.id;
...
var onFailureGetListing = function onFailureGetListing(data) {
  console.error('error');
};

var onSuccessGetAllListings = function onSuccessGetAllListings(data) {
  var listings = data.listings;
...
var onFailGetAllListings = function onFailGetAllListings() {
...
module.exports = {
  ...
  newFail: newFail,
  onSuccessGetListing: onSuccessGetListing,
  onFailureGetListing: onFailureGetListing,
  onSuccessGetAllListings: onSuccessGetAllListings,
  onFailGetAllListings: onFailGetAllListings,
